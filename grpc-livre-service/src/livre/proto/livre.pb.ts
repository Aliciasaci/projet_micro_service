...
export interface LivreServiceClient {
  ...
  addRecetteToLivre(request: AddRecetteToLivreRequest): Observable<AddRecetteToLivreResponse>;
...
export interface LivreServiceController {
  ...
  ): Promise<AddRecetteToLivreResponse> | Observable<AddRecetteToLivreResponse> | AddRecetteToLivreResponse;
  ...
  list(request: ListLivreRequest): Promise<ListLivreResponse> | Observable<ListLivreResponse> | ListLivreResponse;
}

export function LivreServiceControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = ["get", "add", "addRecetteToLivre", "update", "delete", "list"];
